...
const Login = () => {
  ...
  const connectWallet = async () => {
    ...
    try {
      ...
      const contractInstance = new ethers.Contract(
        "0x7906632B036f9D1E63FFdcb4EB1317880D06D799",
        Registry.abi,
        ethersSigner
      );
  ...
  return (
    <div
      ref={vantaRef}
      className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-900 to-indigo-900 relative overflow-hidden"
    >
      ...
      <div className="z-10 w-full max-w-screen-xl px-6 flex flex-col items-center">
        ...
        <div className="text-center mb-10 animate-fade-in">
          ...
          <p className="text-blue-100 text-xl max-w-xl">
            Secure & Transparent Property Management on Blockchain
          </p>
        </div>
        ...
        {!account ? (
          <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-white/20 w-full max-w-md transform transition-all hover:scale-102 hover:shadow-blue-500/20">
            ...
            <p className="text-blue-100 mb-6">
              Connect your MetaMask wallet to access the decentralized land
              registry platform.
            </p>
          ...
          <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-white/20 w-full max-w-md transform transition-all hover:scale-102 hover:shadow-blue-500/20">
            ...
            <div className="mb-6">
              <label
                htmlFor="role"
                className="block text-blue-100 font-medium mb-2"
              >
                Select Role
              </label>
