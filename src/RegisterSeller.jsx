...
const RegisterSeller = () => {
  ...
  const apiSecret =
    "318a60d3bf31978bd8bd9bb490e2153201e5600efdbf49ac167aa15cc2ca7dfb"; // Replace with your Pinata API secret
    ...
    if (provider) {
      try {
        ...
        const contractInstance = new ethers.Contract(
          "0x7906632B036f9D1E63FFdcb4EB1317880D06D799", // Replace with your contract address
          Registry.abi,
          ethersSigner
        );
        ...
        <div className="bg-white shadow-xl rounded-xl overflow-hidden">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Enter the total number of land parcels you currently own
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Upload valid government ID proof (Passport, Driver's License,
                  or Voter ID)
                </p>
              </div>
            </div>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-100">
            ...
            <p className="mt-4 text-center text-xs text-gray-600">
              ...
              Policy. Your information will be securely stored on the
              blockchain.
            </p>
          </div>
        </div>
