    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <p className="mt-4 text-gray-700">Only registered sellers can view and approve land purchase requests.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-1">Manage land purchase requests from buyers</p>
        </div>
        <div className="p-6">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Approve Request</th>
                </tr>
              </thead>
                  ...
                  requests.map((request) => (
                    <tr key={request.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap font-mono text-sm">
                        {request.buyerId.slice(0, 6)}...{request.buyerId.slice(-4)}
                        <button 
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">{request.landId}</td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        >
                          {request.approved ? "Already Approved" : "Approve Request"}
                        </button>
                      </td>
                    </tr>
                  ))
