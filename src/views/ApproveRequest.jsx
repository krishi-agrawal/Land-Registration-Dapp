...
<div className="bg-gray-50 min-h-screen p-6">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="mb-6">
      ...
      <p className="text-gray-600 mt-1">Manage and approve buyer requests for your properties</p>
    </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="bg-white p-8 rounded-xl shadow-2xl text-center max-w-md">
          ...
          <p className="mt-2 text-gray-600">
            Please wait while the blockchain confirms your action. This may take a moment.
          </p>
        </div>
      </div>
    )}
      ...
      <div className="p-6 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-blue-100 mt-1">Review and approve requests from potential buyers</p>
          </div>
        </div>
      </div>
                ...
                <tr>
                  <td colSpan="5" className="px-4 py-8 text-center text-gray-500">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm mt-1">When buyers request your land, they will appear here</p>
                    </div>
                  </td>
                </tr>
              ) : (
                requests.map((request, index) => (
                  <tr key={request.id} className={index % 2 === 0 ? 'bg-white hover:bg-blue-50' : 'bg-gray-50 hover:bg-blue-50'}>
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                      #{request.id}
                    </td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-700">
                      <div className="flex items-center">
                        <span className="font-mono">{request.buyerId.slice(0, 6)}...{request.buyerId.slice(-4)}</span>
                        <button
                          className="ml-2 text-gray-400 hover:text-blue-600 transition-colors"
                          onClick={() => navigator.clipboard.writeText(request.buyerId)}
                          title="Copy address"
                        >
