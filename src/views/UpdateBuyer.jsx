...
const UpdateBuyer = () => {
  ...
  const getVerificationStatus = () => {
    if (verified) {
      return <p className="text-green-600 font-semibold">Verified <i className="fas fa-user-check"></i></p>;
    } else if (rejected) {
      return <p className="text-red-600 font-semibold">Rejected <i className="fas fa-user-times"></i></p>;
    } else {
      return <p className="text-yellow-600 font-semibold">Not Yet Verified <i className="fas fa-user-cog"></i></p>;
    }
  };
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            <form>
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2">Your Wallet Address:</label>
                <input 
                  disabled 
                  type="text" 
                  value={address}
