...
const SellerInfo = () => {
  ...
  const connectWallet = async () => {
    if (provider) {
      try {
        ...
        console.log("Is seller: ", await landContractInstance.isSeller("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"))
  ...
  const loadSellerData = async (contract) => { 
    try {
      ...
      // console.log("aaa: ", aa)  
      console.log("Is seller: ", contract.isSeller("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"))
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
          ...
          <p className="text-gray-700">
            You are not verified to view this page. Only verified Land Inspectors can access the seller verification dashboard.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800">Seller Verification Dashboard</h1>
        <p className="text-gray-600">Verify or reject seller applications for the land registration system.</p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-5">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">{sellersList.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-5">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">
                {sellersList.filter(seller => !seller.isVerified && !seller.isRejected).length}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">Sellers Information</h2>
        </div>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Owned Lands</th>
              ...
              {sellersList.length > 0 ? (
                sellersList.map((seller) => (
                  <tr key={seller.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{seller.age.toString()}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{seller.aadharNumber}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{seller.panNumber}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{seller.ownedLands.toString()}</td>
